...
static void Shop_ShowQtyWithinInventory(ShopMenu *shopMenu)
{
    ...
    if (shopMenu->martType == MART_TYPE_NORMAL) {
        ...
        inventoryQty = SealCase_GetTotalSealCount(shopMenu->destInventory, shopMenu->itemId);
    } else {
        inventoryQty = 0;
    }
...
static u8 Shop_ShowPurchaseMessage(ShopMenu *shopMenu)
{
    ...
    if (shopMenu->martType == MART_TYPE_NORMAL) {
        ...
        canFitItem = SealCase_CanChangeSealAmount(shopMenu->destInventory, shopMenu->itemId, shopMenu->itemAmount);
    }
...
static u8 Shop_ConfirmItemPurchase(ShopMenu *shopMenu)
{
    ...
    if (shopMenu->martType == MART_TYPE_NORMAL) {
        ...
        SealCase_TryChangeSealCount(shopMenu->destInventory, shopMenu->itemId, shopMenu->itemAmount);
    }
